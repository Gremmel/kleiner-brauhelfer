...
private:
    ...
    static double interpolate(double x1,double y1,double x2,double y2,double x3,double y3,double x4,double y4,double x);
    ...
    static double GetHopfenausbeute(double Kochzeit, double Stammwuerze, bool pellets);
...
public:
    ...
    static double BerDichteWasser(double Temperatur);
    static double BerVolumenWasser(double Temperatur1, double Temperatur2, double VolumenT1);
    static double GetTatsaechlicherEVG(double SW, double SVP);
    static double GetScheinbarerEVG(double SW, double SVP);
    static double GetIBU(double Wuerzemenge, double SW, double Hopfenmenge, double AlphaP, double Kochzeit, bool Pellets);
    static double BerCO2Gehalt(double druck, double temperatur);
    static QColor GetFarbwert(double EBC);
	double getEBC();
	double EBC;
  ...
  QColor GetFarbwert(double* aSchuettung, double* aFarbwerte, int Anzahl, double SW, int Korrektur);
    static double GetSudhausausbeute(double SW, double Menge, double Schuettung);
    static double GetGradPlato(double Dichte);
    static double densityAtX(double platoMeasure, double temperature, double calibrationTemp);
	double GetSpundungsdruck();
    static double GetWasserVerschneidung(double SWSoll, double SWIst, double Menge);
  ...
  double GetPfanneVoll(double verdampfungsziffer, int kochdauer, double cWunschmenge);
    static double BerAlkohoVol(double SW, double SVP);
  ...
  double GetNachguss(double verdampfungsziffer, int kochdauer, double korrektur);
    ...
    static double GetDichte(double GradPlato);
